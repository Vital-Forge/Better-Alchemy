...
function better_alchemy:cauldron/recipe_events/item_break

execute store result score *I Cycle run data get entity @s ArmorItems[3].tag.Items
function better_alchemy:cauldron/recipe_events/create_potions

function better_alchemy:cauldron/recipe_events/collapse_effects/start
