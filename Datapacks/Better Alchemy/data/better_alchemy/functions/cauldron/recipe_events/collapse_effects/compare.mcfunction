...
execute if score *A V1 = *B V1 run function better_alchemy:cauldron/recipe_events/collapse_effects/compare_hit

scoreboard players remove *J Cycle 1
execute if score *J Cycle matches 1.. run function better_alchemy:cauldron/recipe_events/collapse_effects/compare