...
execute if data storage vf:ba CycleItem[1] run function datapack:cauldron/recipe_events/collapse_effects/compress_compresed_effects
...
execute if score *I Cycle matches 1.. run function datapack:cauldron/recipe_events/collapse_effects/compress_effects