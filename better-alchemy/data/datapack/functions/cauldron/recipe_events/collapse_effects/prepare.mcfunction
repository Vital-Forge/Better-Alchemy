...
function datapack:cauldron/recipe_events/collapse_effects/compare

data modify entity @s ArmorItems[3].tag.Potions append from storage vf:ba CycleItem

scoreboard players remove *I Cycle 1
execute if score *I Cycle matches 1.. run function datapack:cauldron/recipe_events/collapse_effects/prepare